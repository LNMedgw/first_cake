...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'last_login_at' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'created' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'modified' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_indexes' => [
            'indexRole' => ['type' => 'index', 'columns' => ['role'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'role' => 1,
                'last_login_at' => '2019-01-21 05:34:38',
                'created' => '2019-01-21 05:34:38',
                'modified' => '2019-01-21 05:34:38'
            ],
        ];
        parent::init();
    }
